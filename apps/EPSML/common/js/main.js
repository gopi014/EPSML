	...
	for(var i=0;i<=length;i++){
		...
		if (i==0){
			for(var j=0;j<(32-currday);j++)
				...
				dateCell.setAttribute("style", "background-color: grey;");
				currentdate1++;
				}
		}else{
			for(var j=0;j<(32-currday);j++){
				...
				if(resultset[i-1]['day'+currentdate2] =='First' ){
					shiftCell.setAttribute("style", "background-color: #F4FA58;");
				}
				...
				{
					shiftCell.setAttribute("style", "background-color: #58FAD0;");
				}
				if(resultset[i-1]['day'+currentdate2] =='General' )
				{
					shiftCell.setAttribute("style", "background-color: #82FA58;");
				}

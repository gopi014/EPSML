...
<<<<<<< HEAD
var procedureStatement = WL.Server.createSQLStatement("select * from user_name as na inner join user_team as te on na.id=te.emp_id inner join shift_schedule sh on te.emp_id= sh.emp_id where sh.shift_month=?");
function smanager(month) {
	return WL.Server.invokeSQLStatement({

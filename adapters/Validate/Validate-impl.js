...
var checkavailablityquery=WL.Server.createSQLStatement("select sa.availablity,st.start_time, st.shift_name from shift_actuals sa,shift_schedule ss, shift_time st where ss.emp_id= st.emp_id and ss."+x1+" =st.shift_name and ss.emp_id=? and sa.shift_month=? and sa.year=?");
